            ...
            <form className="client-form">
                <div className="personal-info">
                    ...
                    <div className="name input-container">
                        ...
                        <div className='flex'>
                            <input type="text" className='w-45' id="firstName" placeholder="Enter First Name" required />
                            <input type="text" className='w-45' id="lastName" placeholder="Enter Last Name" required />
                        </div>
                    </div>
                ...
                <div className="contact">
                    <div className="phone input-container">
                        ...
                        <div className="div flex">
                            <input type="number" className='w-45' id="phone" placeholder="Phone Number" required />
                ...
                <div className="interests">
                    <div className='flex'>
                        <div className="w-45 requirement input-container">
                            ...
                            <select className='w-100' id="requirement" required>
                        ...
                        <div className="w-45 budget input-container">
                            ...
                            <input className='w-100' type="number" id="budget" placeholder="Budget" required />
                        </div>
                    </div>
